...
Begin VB.Form banktransactions_add_remove 
   ClientHeight    =   3645
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   5400
   Icon            =   "banktransactions_add_remove.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   3645
   ScaleWidth      =   5400
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      Picture         =   "banktransactions_add_remove.frx":0A02
      Caption         =   ""
      Align           =   5
      AutoSizeChildren=   0
      BorderWidth     =   0
      ...
      Begin TDBNumber6Ctl.TDBNumber TDBNumber2 
         ...
         _ExtentX        =   5318
         _ExtentY        =   661
         Calculator      =   "banktransactions_add_remove.frx":1B3E
         Caption         =   "banktransactions_add_remove.frx":1B5E
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   161
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "banktransactions_add_remove.frx":1BCA
         Keys            =   "banktransactions_add_remove.frx":1BE8
         Spin            =   "banktransactions_add_remove.frx":1C32
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   1
      ...
      Begin VB.CommandButton Command2 
         ...
         Left            =   2640
         MaskColor       =   &H00FF0000&
         Picture         =   "banktransactions_add_remove.frx":1C5A
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   2880
         Width           =   870
      ...
      Begin VB.CommandButton Command1 
         ...
         Left            =   1680
         MaskColor       =   &H00FFFFFF&
         Picture         =   "banktransactions_add_remove.frx":2344
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   2880
         Width           =   870
      ...
      Begin TDBText6Ctl.TDBText TDBText1 
         ...
         _ExtentX        =   5318
         _ExtentY        =   661
         Caption         =   "banktransactions_add_remove.frx":2D46
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   161
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "banktransactions_add_remove.frx":2DB2
         Key             =   "banktransactions_add_remove.frx":2DD0
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
      ...
      Begin TDBNumber6Ctl.TDBNumber TDBNumber1 
         ...
         _ExtentX        =   5318
         _ExtentY        =   661
         Calculator      =   "banktransactions_add_remove.frx":2E14
         Caption         =   "banktransactions_add_remove.frx":2E34
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   161
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "banktransactions_add_remove.frx":2EA0
         Keys            =   "banktransactions_add_remove.frx":2EBE
         Spin            =   "banktransactions_add_remove.frx":2F08
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   -2147483643
      ...
      Begin TDBDate6Ctl.TDBDate TDBDate1 
         ...
         _ExtentX        =   5318
         _ExtentY        =   661
         Calendar        =   "banktransactions_add_remove.frx":2F30
         Caption         =   "banktransactions_add_remove.frx":3048
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   161
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "banktransactions_add_remove.frx":30B4
         Keys            =   "banktransactions_add_remove.frx":30D2
         Spin            =   "banktransactions_add_remove.frx":3130
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   -2147483643
      ...
      Begin TrueOleDBList80.TDBCombo TDBCombo1 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"banktransactions_add_remove.frx":3158
   ...
   End
End
Attribute VB_Name = "banktransactions_add_remove"
...
If vbanktrans_add_remove = False And TDBNumber1.Value > TDBNumber2.Value Then _
MsgBox "то посо поу сулпкгяысате упеябаимеи то диахесило посо. паяайакы диояхысте.", vbOKOnly, "йемтяийа аявеиа": Exit Sub

If TDBCombo1.Text = "" Or TDBDate1.ValueIsNull = True Or _
...
If vbanktrans_add_remove = True Then
...
Else
    ...
    mainMDIForm1.TData20.Recordset.Fields(5) = TDBNumber1.Value
End If
...
If vbanktrans_add_remove = True Then
    Me.Caption = "йатахесг вяглатым се тяапефийо коцаяиасло"
    TDBNumber2.Visible = False
Else
    Me.Caption = "амакгьг вяглатым апо тяапефийо коцаяиасло"
