...
Begin VB.Form virtualaccounts_add_remove 
   ClientHeight    =   3930
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   5430
   Icon            =   "virtualaccounts_add_remove.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   3930
   ScaleWidth      =   5430
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      Picture         =   "virtualaccounts_add_remove.frx":0A02
      Caption         =   ""
      Align           =   5
      AutoSizeChildren=   0
      BorderWidth     =   0
      ...
      Begin TrueOleDBList80.TDBCombo TDBCombo2 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"virtualaccounts_add_remove.frx":1B3E
      ...
      Begin VB.CommandButton Command1 
         ...
         Left            =   1680
         MaskColor       =   &H00FFFFFF&
         Picture         =   "virtualaccounts_add_remove.frx":1BE8
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   3120
         Width           =   870
      ...
      Begin VB.CommandButton Command2 
         ...
         Left            =   2640
         MaskColor       =   &H00FF0000&
         Picture         =   "virtualaccounts_add_remove.frx":25EA
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   3120
         Width           =   870
      ...
      Begin TDBNumber6Ctl.TDBNumber TDBNumber2 
         ...
         _ExtentX        =   5318
         _ExtentY        =   661
         Calculator      =   "virtualaccounts_add_remove.frx":2CD4
         Caption         =   "virtualaccounts_add_remove.frx":2CF4
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   161
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "virtualaccounts_add_remove.frx":2D60
         Keys            =   "virtualaccounts_add_remove.frx":2D7E
         Spin            =   "virtualaccounts_add_remove.frx":2DC8
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   1
      ...
      Begin TDBText6Ctl.TDBText TDBText1 
         ...
         _ExtentX        =   5318
         _ExtentY        =   661
         Caption         =   "virtualaccounts_add_remove.frx":2DF0
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   161
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "virtualaccounts_add_remove.frx":2E5C
         Key             =   "virtualaccounts_add_remove.frx":2E7A
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
      ...
      Begin TDBNumber6Ctl.TDBNumber TDBNumber1 
         ...
         _ExtentX        =   5318
         _ExtentY        =   661
         Calculator      =   "virtualaccounts_add_remove.frx":2EBE
         Caption         =   "virtualaccounts_add_remove.frx":2EDE
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   161
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "virtualaccounts_add_remove.frx":2F4A
         Keys            =   "virtualaccounts_add_remove.frx":2F68
         Spin            =   "virtualaccounts_add_remove.frx":2FB2
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   -2147483643
      ...
      Begin TDBDate6Ctl.TDBDate TDBDate1 
         ...
         _ExtentX        =   5318
         _ExtentY        =   661
         Calendar        =   "virtualaccounts_add_remove.frx":2FDA
         Caption         =   "virtualaccounts_add_remove.frx":30F2
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   161
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "virtualaccounts_add_remove.frx":315E
         Keys            =   "virtualaccounts_add_remove.frx":317C
         Spin            =   "virtualaccounts_add_remove.frx":31DA
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   -2147483643
      ...
      Begin TrueOleDBList80.TDBCombo TDBCombo1 
         ...
         RowSubDividerColor=   14215660
         AddItemSeparator=   ";"
         _PropDict       =   $"virtualaccounts_add_remove.frx":3202
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   End
End
Attribute VB_Name = "virtualaccounts_add_remove"
...
mainMDIForm1.TData21.SourceRecordset.MoveFirst
Do While Not mainMDIForm1.TData21.SourceRecordset.EOF
If mainMDIForm1.TData21.SourceRecordset.Fields(2) = TDBCombo2.Text Then
plussum = plussum + mainMDIForm1.TData21.SourceRecordset.Fields(4)
minussum = minussum + mainMDIForm1.TData21.SourceRecordset.Fields(5)
End If
mainMDIForm1.TData21.SourceRecordset.MoveNext
...
mainMDIForm1.TData21.Recordset.AddNew
mainMDIForm1.TData21.Recordset.Fields(1) = usrid
mainMDIForm1.TData21.Recordset.Fields(2) = TDBCombo2.Text
mainMDIForm1.TData21.Recordset.Fields(3) = TDBDate1.Text
mainMDIForm1.TData21.Recordset.Fields(4) = TDBNumber1.Value
...
Me.Caption = "летажояа летану коцистийым коцаяиаслым"
...
TDBCombo2.Columns(0).Visible = True
End Sub
...
If TDBCombo1.Text = TDBCombo2.Text And TDBCombo2.Text <> "" Then
MsgBox "ои коцаяиалои апо йаи пяос еимаи идиои. паяайкаы диояхысте.", _
vbapllicationmodal + vbOKOnly, "йемтяийа аявеиа"
TDBCombo2.Text = ""
Exit Sub
End If
...
Private Sub TDBCombo2_Close()
If TDBCombo2.Text = TDBCombo1.Text Then
MsgBox "ои коцаяиалои апо йаи пяос еимаи идиои. паяайкаы диояхысте.", _
vbapllicationmodal + vbOKOnly, "йемтяийа аявеиа"
TDBCombo2.Text = ""
Exit Sub
